...
state_height = stage_size[1] # 스테이지의 높이 위에 캐릭터를 두기 위해 사용함.
...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-21, -18, -15, -12, -9] # index 0,1,2,3 에 해당하는 값
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # 세로 위치
        # 스테이지에 튕겨서 올라가는 처리
        if ball_pos_y >= screen_height - state_height - ball_height:
    ...
    screen.blit(stage, (0, screen_height - state_height))
